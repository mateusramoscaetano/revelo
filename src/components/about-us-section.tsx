      ...
      <div className="space-y-4 flex-col w-full items-center justify-center">
        ...
        <div className="flex flex-col lg:flex-row gap-[22px]">
          <div className="space-y-6 md:mr-4 mb-[37px] hidden xl:flex xl:flex-col">
            ...
            <div className="flex  cursor-pointer group">
              <motion.div className="flex items-center justify-center px-3 py-2.5 bg-revelo tracking-wider rounded-lg relative w-[105px] h-7 group-hover:scale-x-[129%] group-hover:scale-y-125  duration-300">
