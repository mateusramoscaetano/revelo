  ...
  return (
    <div className="flex flex-col lg:flex-row gap-[22px]">
      ...
      <p className="text-zinc-300 text-sm max-w-[340px] tracking-wider">
        Revelamos aquilo que se é incapaz de enxergar, mas de certo modo já se
        sabe. Pode ser uma visão de mundo singularmente diferente ou tão próxima
        que parece milagre quando se olhássemos pelos seus olhos e isso te
        fizesse lembrar quem é e o que pode ser.
      </p>
      <p className="text-zinc-300 text-sm max-w-[340px] tracking-wider">
        Nosso ponto de vista não precisa ser coerente. É raramente é simples.
        Podemos ter pontos de vista diferentes, às vezes contraditórios. Querer
        estreitar tudo numa única expressão elegante é irreal e limitador, o
        mundo totalmente cor-de-rosa é bonito demais para ser verdadeiro.
      </p>
    </div>
  );
}
